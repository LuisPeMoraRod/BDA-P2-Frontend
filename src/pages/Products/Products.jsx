...
const managementTypes = [
  { value: CREATE, label: "Create a new product" },
  { value: UPDATE, label: "Edit a product's info" },
  { value: DELETE, label: "Delete a product" },
];
...
const Products = () => {
  ...
  return (
    <div className="centered">
      <h3 className="mb-5 fw-light">Products Management</h3>
      <Form>
        <Container>
          <Row>
            <Col>
